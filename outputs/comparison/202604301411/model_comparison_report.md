...
| 模型 | Run ID | 输出目录 |
|---|---|---|
| DNN | 202604291103 | outputs/dnn/202604291103 |
...
|---|---|---|---|---|---|---|
| dnn | 16 | 6 | 10 | nan | nan | None |
| wide_deep | 16 | 6 | 10 | nan | 20.0 | cuda |
| graphsage | 16 | 6 | 10 | 0.4871 | 20.0 | cuda |
| multimodal | 16 | 6 | 10 | nan | 10.0 | cuda |
...
以下图表已生成至 outputs/comparison/ 目录：
...
- `outputs/comparison/model_prediction_quality_check.csv`
- `outputs/comparison/model_prediction_quality_check.json`
- `outputs/comparison/topk_comparison.csv`
- `outputs/comparison/model_score_distribution.csv`
- `outputs/comparison/model_score_distribution.png`
- `outputs/comparison/metric_bar_auc.png`
- `outputs/comparison/metric_bar_f1.png`
- `outputs/comparison/metric_bar_precision_recall.png`
- `outputs/comparison/model_comparison_report.md`
