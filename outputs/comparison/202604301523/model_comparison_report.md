...
> Comparison Run ID：202604301523

| 模型 | Run ID | 输出目录 |
|---|---|---|
| DNN | 202604301440 | outputs/dnn/202604301440 |
| Wide & Deep | 202604291505 | outputs/wide_deep/202604291505 |
| GraphSAGE | 202604291958 | outputs/graphsage/202604291958 |
| Multimodal | 202604292059 | outputs/multimodal/202604292059 |
...
| wide_deep | 16 | 6 | 10 | nan | 20 | cuda |
| graphsage | 16 | 6 | 10 | 0.4871 | 20 | cuda |
| multimodal | 16 | 6 | 10 | nan | 10 | cuda |
...
以下图表已生成至 outputs\comparison\202604301523/ 目录：
...
- `outputs\comparison\202604301523/model_metrics_summary.csv`
- `outputs\comparison\202604301523/model_metrics_summary.json`
- `outputs\comparison\202604301523/model_prediction_quality_check.csv`
- `outputs\comparison\202604301523/model_prediction_quality_check.json`
- `outputs\comparison\202604301523/topk_comparison.csv`
- `outputs\comparison\202604301523/model_score_distribution.csv`
- `outputs\comparison\202604301523/model_score_distribution.png`
- `outputs\comparison\202604301523/metric_bar_auc.png`
- `outputs\comparison\202604301523/metric_bar_f1.png`
- `outputs\comparison\202604301523/metric_bar_precision_recall.png`
- `outputs\comparison\202604301523/model_comparison_report.md`
