...
class WebVideoMeta(BaseModel):
    ...
    # 作者侧补充字段
    follower_count: Optional[int] = Field(None, description="作者粉丝数")
    total_favorited: Optional[int] = Field(None, description="作者总获赞数")
    signature: Optional[str] = Field(None, description="作者签名/简介")
    ...
    sec_item_id: Optional[str] = Field(None, description="安全化视频ID")
    group_id: Optional[str] = Field(None, description="视频分组ID")
    comment_gid: Optional[str] = Field(None, description="评论关联视频ID")
    share_url: Optional[str] = Field(None, description="分享链接")
    caption: Optional[str] = Field(None, description="视频文案(caption字段)")
    desc: Optional[str] = Field(None, description="视频文案(desc字段)")
    preview_title: Optional[str] = Field(None, description="页面预览标题")
    item_title: Optional[str] = Field(None, description="视频标题字段")
    aweme_type: Optional[int] = Field(None, description="视频/内容类型编码")
    media_type: Optional[int] = Field(None, description="媒体类型编码")
    region: Optional[str] = Field(None, description="内容地区")
    is_top: Optional[int] = Field(None, description="是否置顶")
    is_ads: Optional[bool] = Field(None, description="是否广告内容")
    is_life_item: Optional[bool] = Field(None, description="是否生活服务相关内容")
    original: Optional[int] = Field(None, description="是否原创相关标记")
    play_count: Optional[int] = Field(None, description="播放数")
    recommend_count: Optional[int] = Field(None, description="推荐相关计数")
    admire_count: Optional[int] = Field(None, description="赞赏/支持相关计数")
    ...
    sec_uid: Optional[str] = Field(None, description="作者安全ID")
    unique_id: Optional[str] = Field(None, description="作者抖音号/唯一标识")
    short_id: Optional[str] = Field(None, description="作者短ID")
    custom_verify: Optional[str] = Field(None, description="个人认证文本")
    enterprise_verify_reason: Optional[str] = Field(None, description="企业认证原因/文本")
    # ====== 2026-05-06 字段扩充: raw_music P1 ======
    music_id: Optional[str] = Field(None, description="音乐ID")
    music_title: Optional[str] = Field(None, description="音乐名称")
    music_author: Optional[str] = Field(None, description="音乐作者")
    music_duration: Optional[int] = Field(None, description="音乐时长(秒)")
    music_owner_id: Optional[int] = Field(None, description="音乐归属作者ID")
    music_owner_nickname: Optional[str] = Field(None, description="音乐归属作者昵称")
    is_original_sound: Optional[bool] = Field(None, description="是否原创声音")
    # ====== 2026-05-06 字段扩充: raw_video_media P1 ======
    cover_uri: Optional[str] = Field(None, description="封面资源URI")
    origin_cover_uri: Optional[str] = Field(None, description="原始封面URI")
    dynamic_cover_uri: Optional[str] = Field(None, description="动态封面URI")
    origin_cover_width: Optional[int] = Field(None, description="原始封面宽度")
    origin_cover_height: Optional[int] = Field(None, description="原始封面高度")
    dynamic_cover_width: Optional[int] = Field(None, description="动态封面宽度")
    dynamic_cover_height: Optional[int] = Field(None, description="动态封面高度")
    video_width: Optional[int] = Field(None, description="原视频宽度")
    video_height: Optional[int] = Field(None, description="原视频高度")
    origin_cover_url_list: Optional[str] = Field(None, description="原始封面URL列表")
    dynamic_cover_url_list: Optional[str] = Field(None, description="动态封面URL列表")
